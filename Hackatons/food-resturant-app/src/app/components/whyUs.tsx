        ...
        <div className="mt-[120px]">
            ...
            <div className="mt-[62px]">
                ...
                <div className="mt-[54px] flex gap-[35px]">
                    <div>
                        <div className="w-[102px] h-[100px] rounded-md bg-[#FF9F0D]  place-content-center">
                ...
                <div className="w-[374px] h-[93px] mt-[34px] rounded-md flex">
                    <div className="w-[10px] h-full bg-[#FF9F0D]"></div>
                    <div className="pl-[41px] flex grow bg-white items-center justify-around">
